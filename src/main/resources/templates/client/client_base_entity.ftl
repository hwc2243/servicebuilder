...
<#else>
import ${clientModelPackage}.${attribute.name?cap_first}Type;
</#if>
...
import ${clientModelPackage}.${referencedEntity.name?cap_first};
</#list>
<#if entity.parent??>
import ${clientModelPackage}.${entity.parent?cap_first};
</#if>
...
{
<@client_key_attribute entity entity.key/>
